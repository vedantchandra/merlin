...
class StarBasis(object):
    ...
    def normalize(self,logr=None,logl=None,logt=None):
        ...
        """
        if logr != None:
            twologr = 2.* (logr + log_rsun_cgs)
        elif logl != None:
            twologr = ((logl + log_lsun_cgs) -
                       4 * logt - log_SB_cgs - log4pi)
        else:
            return 1.0
