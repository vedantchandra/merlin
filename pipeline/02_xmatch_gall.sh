...
#SBATCH -o /n/holystore01/LABS/conroy_lab/Lab/vchandra/mage/logs/xgall/xgall_%a.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e /n/holystore01/LABS/conroy_lab/Lab/vchandra/mage/logs/xgall/xgall_%a.err  # File to which STDERR will be written, %j inserts jobid
