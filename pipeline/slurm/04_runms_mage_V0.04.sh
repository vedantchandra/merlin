...
#SBATCH -o /n/holyscratch01/conroy_lab/vchandra/mage/logs/mage/V0.04/%a.out
#SBATCH -e /n/holyscratch01/conroy_lab/vchandra/mage/logs/mage/V0.04/%a.err
...
python 04_runms_star.py --catalog=mage --ind=$SLURM_ARRAY_TASK_ID --version=V0.04 --npoints=500 --skipfit=0